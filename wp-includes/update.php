 ...
 *
 * Checks against the WordPress server at api2.wordpress.org. Will only check
...
function wp_version_check( $extra_stats = array(), $force_check = false ) {
	...
	$url      = 'http://api2.wordpress.org/core/version-check/1.7/?' . http_build_query( $query, null, '&' );
	$http_url = $url;
...
function wp_update_plugins( $extra_stats = array() ) {
	...
	$url      = 'http://api2.wordpress.org/plugins/update-check/1.1/';
	$http_url = $url;
	$ssl      = wp_http_supports( array( 'ssl' ) );
...
function wp_update_themes( $extra_stats = array() ) {
	...
	$url      = 'http://api2.wordpress.org/themes/update-check/1.1/';
	$http_url = $url;
	$ssl      = wp_http_supports( array( 'ssl' ) );
